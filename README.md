...
[![CI](https://github.com/YOUR_USERNAME/archlab/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/archlab/actions)
...
```bash
git clone https://github.com/YOUR_USERNAME/archlab.git
cd archlab
